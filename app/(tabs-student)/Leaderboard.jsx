  ...
  return (
    ...
    >
      <Image
        source={
          course.pfp
            ? { uri: `${API.BASE_URL}/Images/ProfilePictures/${course.pfp}` }
              ...
              <View style={styles.profContainer}>
                <View style={styles.profContainer2}>
                  <Image
                    style={[
                      styles.rankProfPic,
                      { borderColor: "#adadadff", borderWidth: 4 },
                    ]}
                    source={
                      users[1].pfp
                        ? {
                            uri: `${API.BASE_URL}/Images/ProfilePictures/${users[1].pfp}`,
                          }
                        : require("@/assets/icons/user-pic.png")
                    }
                    resizeMode="contain"
                ...
                <View style={styles.profContainer3}>
                  <Image
                    style={[
                      styles.rankProfPic,
                      { borderColor: "#fac105ff", borderWidth: 4 },
                    ]}
                    source={
                      users[0].pfp
                        ? {
                            uri: `${API.BASE_URL}/Images/ProfilePictures/${users[0].pfp}`,
                          }
                        : require("@/assets/icons/user-pic.png")
                    }
                    resizeMode="contain"
                ...
                <View style={styles.profContainer4}>
                  <Image
                    style={[
                      styles.rankProfPic,
                      { borderColor: "#CD7F32", borderWidth: 4 },
                    ]}
                    source={
                      users[2].pfp
                        ? {
                            uri: `${API.BASE_URL}/Images/ProfilePictures/${users[2].pfp}`,
                          }
                        : require("@/assets/icons/user-pic.png")
                    }
                    resizeMode="contain"
