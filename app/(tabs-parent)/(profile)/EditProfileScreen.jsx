...
export default function EditProfileScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity onPress={pickImage}>
        <Image
          source={
            form.imageUri
              ? { uri: form.imageUri }
              : loggedInUserPfp ? {uri:`${API.BASE_URL}/Images/ProfilePictures/${loggedInUserPfp}`} :require("@/assets/icons/user-pic.png")
          }
          style={styles.avatar}
        />
      ...
      {renderInput('Full Name', form.name, value => handleChange('name', value))}
      {renderInput('Phone Number', form.phone, value => handleChange('phone', value), 'phone-pad')}
...
const renderInput = (label, value, onChangeText, keyboardType = 'default', secure = false) => (
